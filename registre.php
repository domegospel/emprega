	...
	<div id="interface">
      <?php
		...
		if(isset($_POST['cadastrar'])):
			...
			# Insert
			if($usuario->insert()){
				echo "<script type=\"text/javascript\">alert('Usuário Inserido');</script>";
			}
                          ...
                          <form method="post" id="fRegistre" action="">
                        	<fieldset id="pessoa">
                        	  ...
                        	  <p>
                        	    ...
                        	    <input type="text" name="tNome" id="cNome" size="30" maxlength="40" placeholder="Exemplo: João da Silva"/> *
                        	  </p>
                              <p>
                        	    <label for="cEmpresa">Empresa.....................: </label>
                        	    <input type="text" name="tEmpresa" id="cEmpresa" size="30" maxlength="40" placeholder="Exemplo: RestauranteSilva"/>
                        	  </p>
                        	  <p>
                        	  ...
                        	  <p>
                        	    <label for="cEmailRecuperacao">E-Mail de Recuperação:</label>
                        		<input type="email" name="tEmailRecuperacao" id="cEmailRecuperacao" size="20" maxlength="30" placeholder="Email para recuperar a senha"/> *
                        	  </p>
                        	  <p>
                        	  ...
                        	  <p>
                        	    <label for="cConfirmaSenha">Confirmação de Senha.:</label>
                        		<input type="password" name="tConfirmaSenha" id="cConfirmaSenha" size="10" maxlength="10" placeholder="Confirme a senha"/> *
                        	  </p>
                        	</fieldset>
